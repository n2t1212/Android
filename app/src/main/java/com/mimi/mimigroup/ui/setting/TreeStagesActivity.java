...
public class TreeStagesActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tree_stages);

        adapter = new FragmentPagerTabAdapter(getSupportFragmentManager());
        viewPager.setAdapter(adapter);
        tabLayout.setupWithViewPager(viewPager);
        adapter.addFragment(new TreeStagesFragment(), "Giai đoạn cây trồng");
    }
    ...
    public void onDownload(){
        ...
        if(currentFragment instanceof SeasonFragment){
            final Dialog oDlg=new Dialog(TreeStagesActivity.this);
