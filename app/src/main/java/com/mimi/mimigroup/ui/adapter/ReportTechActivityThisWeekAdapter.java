...
public class ReportTechActivityThisWeekAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ReportTechCompetitorHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.fragment_report_tech_activity_this_week_item,viewGroup,false));
    }
    ...
    public void onBindViewHolder( final RecyclerView.ViewHolder viewHolder,final int iPos) {
        if(viewHolder instanceof ReportTechCompetitorAdapter.ReportTechCompetitorHolder){
            ((ReportTechCompetitorHolder) viewHolder).bind(smoReportTechActivity.get(iPos));
        }
