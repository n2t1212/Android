...
public class ItemActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tabmain_province);
        adapter = new FragmentPagerTabAdapter(getSupportFragmentManager());
        viewPager.setAdapter(adapter);
        tabLayout.setupWithViewPager(viewPager);
        adapter.addFragment(new ProvinceFragment(), "Tỉnh");
        adapter.addFragment(new DistrictFragment(), "Huyện");
        adapter.addFragment(new WardFragment(), "Xã");
    }
    ...
    public void onDownload(){
       final Fragment currentFragment = adapter.getItem(viewPager.getCurrentItem());
        if(currentFragment instanceof WardFragment){
            final Dialog oDlg=new Dialog(ItemActivity.this);
            ...
            btnAll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((WardFragment)currentFragment).onDownloadClicked(true);
                    oDlg.dismiss();
                }
            });
            btnNew.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((WardFragment)currentFragment).onDownloadClicked(false);
                    oDlg.dismiss();
                }
            });
        ...
        if(currentFragment instanceof DistrictFragment){
            final Dialog oDlg=new Dialog(ItemActivity.this);
            oDlg.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
            oDlg.setContentView(R.layout.dialog_yesnosync);
            oDlg.setTitle("");
            ...
            btnAll.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((DistrictFragment)currentFragment).onDownloadClicked(true);
                    oDlg.dismiss();
                }
            });
            btnNew.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((DistrictFragment)currentFragment).onDownloadClicked(false);
                    oDlg.dismiss();
                }
            });
            btnNo.setOnClickListener(new View.OnClickListener() {
        ...
        if(currentFragment instanceof ProvinceFragment){
            final Dialog oDlg=new Dialog(ItemActivity.this);
            oDlg.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
            oDlg.setContentView(R.layout.dialog_yesnosync);
            oDlg.setTitle("");
            ...
            btnAll.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((ProvinceFragment)currentFragment).onDownloadClicked(true);
                    oDlg.dismiss();
                }
            });
            btnNew.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((ProvinceFragment)currentFragment).onDownloadClicked(false);
                    oDlg.dismiss();
                }
            });
            btnNo.setOnClickListener(new View.OnClickListener() {
