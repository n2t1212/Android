...
public class ProductActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.addFragment(new ProductFragment(), "Sản phẩm");
    ...
    public void onDownload(){
       final Fragment currentFragment = adapter.getItem(viewPager.getCurrentItem());
        if(currentFragment instanceof ProductFragment){
            final Dialog oDlg=new Dialog(ProductActivity.this);
            ...
            btnAll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((ProductFragment)currentFragment).onDownloadClicked(true);
                    oDlg.dismiss();
                }
            });
            btnNew.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((ProductFragment)currentFragment).onDownloadClicked(false);
                    oDlg.dismiss();
                }
            });
