...
public class TreeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.addFragment(new TreeFragment(), "Cây trồng");
        adapter.addFragment(new TreeDiseaseFragment(), "Dịch bệnh");
    }
    ...
    public void onDownload(){
       final Fragment currentFragment = adapter.getItem(viewPager.getCurrentItem());
        if(currentFragment instanceof TreeFragment){
            final Dialog oDlg=new Dialog(TreeActivity.this);
        ...
        if(currentFragment instanceof TreeDiseaseFragment){
            final Dialog oDlg=new Dialog(TreeActivity.this);
            oDlg.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
            oDlg.setContentView(R.layout.dialog_yesnosync);
            oDlg.setTitle("");
            ...
            btnAll.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((TreeDiseaseFragment)currentFragment).onDownloadClicked(true);
                    oDlg.dismiss();
                }
            });
            btnNew.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((TreeDiseaseFragment)currentFragment).onDownloadClicked(false);
                    oDlg.dismiss();
                }
            });
            btnNo.setOnClickListener(new View.OnClickListener() {
